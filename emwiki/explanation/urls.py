...
urlpatterns = [
    ...
    path('<str:name_or_filename>', views.Redirect_ArticleView.as_view(), name='article'),
    path('proofs/<str:article_name>/<str:proof_name>', views.Redirect_ProofView.as_view(), name='proofs'),
    path('refs/<str:article_name>/<str:ref_name>', views.Redirect_RefView.as_view(), name='refs'),
