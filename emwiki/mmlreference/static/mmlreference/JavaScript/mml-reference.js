...
(function() {
  ...
  Searcher = (function() {
    ...
    Searcher.prototype.update_search_results = function(results) {
      ...
      for (_i = 0, _len = results.length; _i < _len; _i++) {
        ...
        li += "<li data-order='" + i + "' class='list-group-item " + t + "'>" + s + "</li>";
      }
  ...
  jump_to = (function(_this) {
    return function(filename, anchor, push_state) {
      ...
      if (filename != null) {
        ...
        return $("#content").load("./mmlreference/start.html #start", null, function() {
          if (push_state) {
            return history.pushState({
              filename: filename,
              anchor: anchor
  ...
  $(document).ready(function() {
    ...
    for (i = _i = 0, _ref = len - 1; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
      ...
      lists.push("<li data-order='" + i + "' class='list-group-item " + type + "'>" + symbol + "</a></li>");
    }
