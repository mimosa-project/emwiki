...
touch "mizcore.cpython-39-x86_64-linux-gnu.so"
cp lib.linux-x86_64-3.9/py_miz_controller.cpython-39-x86_64-linux-gnu.so mizcore.cpython-39-x86_64-linux-gnu.so

cd ../../
# cp build/lib.linux-x86_64-3.9/py_miz_controller.cpython-39-x86_64-linux-gnu.so mizcore.cpython-39-x86_64-linux-gnu.so
...
# cd "lib.linux-x86_64-3.9/py_miz_controller.cpython-39-x86_64-linux-gnu.so"
